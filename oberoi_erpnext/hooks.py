...
fixtures = [{"dt": "Print Format", "filters": [["name", "in", ["Oberoi", "Oberoi Quotation", "Oberoi SI Revised" ]]]},
            {"dt": "Letter Head", "filters": [["name", "in", ["Oberoi", "Oberoi Sales Invoice Noida","Oberoi Sales Invoice Unit I HWR", "Oberoi Sales Invoice Unit II HWR"]]]},
